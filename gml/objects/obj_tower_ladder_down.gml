object_create(
    "obj_tower_ladder_down",
    object_reserve("par_interactable"),
    {
        sprite_index: spr_bell_tower_f2_down_ladder_main,
        create: function() {
            ...
            self.register_interaction(
                ...
                "misc_local/use",
                function() {
                    var point = trellis_point("bell_tower_f1/Bell Tower F2");
                    goto_location_id(LocationId.BellTowerF1)
